  ...
  return (
    <div
      ...
      style={{
        overflow: "hidden",
        zIndex: 1,
        borderRadius: "13px", // Slightly larger to perfectly wrap the 12px card
      }}
      onMouseEnter={(e) => {
    ...
    >
      ...
      >
        ...
        <CardContent className="space-y-2 flex-1 flex flex-col pb-14">
      ...
      <Link
        ...
        onMouseEnter={(e) => {
          ...
          if (cardRef.current) {
            cardRef.current.style.backgroundColor = "var(--bg-surface)";
        ...
        className="absolute left-0 right-0 py-3 block text-center no-underline transition-all duration-300 ease-out"
        style={{
          bottom: "0",
