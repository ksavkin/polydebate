...
> [!IMPORTANT]
> **Security Protocol**: The admin password will be `REDACTED_ADMIN_PASSWORD`. This will be used to generate a secure session. In production, this should be set as an environment variable `ADMIN_PASSWORD`.
